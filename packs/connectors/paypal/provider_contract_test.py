...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the offline PayPal Connector Pack contract")
    ...
    request = json.loads((PACK_DIR / "fixture-transactions.json").read_text(encoding="utf-8"))
    report = run_connector_contract_test(
        registry, runtime, "paypal.transaction_activity", request,
