...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the offline Xero Connector Pack contract")
    ...
    request = json.loads((PACK_DIR / "fixture-trial-balance.json").read_text(encoding="utf-8"))
    report = run_connector_contract_test(
        registry, runtime, "xero.trial_balance", request,
